...
상품명은 반드시 입력 데이터의 project_name 값을 사용해라.
selected_sources 안의 query 값은 검색어이므로 상품명, 제목, 대본, 썸네일, 인포크, 업로드 제목에 상품명처럼 사용하지 마라.
중국어 검색어가 있어도 최종 콘텐츠 문구는 한국어 상품명 중심으로 작성해라.
